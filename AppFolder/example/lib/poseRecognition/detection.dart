...
import 'package:body_detection_example/cc/sports menu/page1.dart';

class Detection extends StatefulWidget {
  const Detection({Key? key, required this.SportName, required this.number, required this.Content, required this.image});
